...
ref_clean_audio = args.ref_clean_audio
ref_noisy_audio = args.ref_noisy_audio
gen_noisy_audio = args.gen_noisy_audip
...
if gen_file:
    ...
    assert gen_noisy_audio is not None
    gen_noisy_audio_list = [gen_noisy_audio]
