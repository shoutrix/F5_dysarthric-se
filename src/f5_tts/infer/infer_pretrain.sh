...
python infer_pretrained.py \
    ...
    --ckpt_file /speech/shoutrik/dysarthric_exp/F5_dysarthric-se/ckpts/F5TTS_small_LibriDys_noisy_clean_02/model_350000.pt \
    --pretrain True \
    ...
    --gen_noisy_audio /speech/shoutrik/speech_enhancement/libri_960_noise_data/noisy_dataset_test/0dB/260_123286_000005_000001.wav \
